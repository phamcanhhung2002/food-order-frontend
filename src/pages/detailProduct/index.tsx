...
const DetailProduct = () => {
  ...
  const handleAddMultipleProduct = () => {
    ...
    toast.success(
      `Add ${Number(qty) < 10 ? "0" + String(qty) : String(qty)} ${
        product.name
      } successfull!`
    );
  };
  ...
  return (
    <article>
      ...
      <section className="flex flex-row justify-between max-lg:flex-col max-lg:gap-y-10">
        <div className="grid grid-cols-4 grid-rows-4 gap-6 basis-[45%] grid-flow-col h-[700px] max-lg:gap-3">
          ...
          <img
            ...
            alt=""
            className="row-span-4 col-span-3 h-full w-full bg-cover"
          />
        </div>
        ...
        <div className="basis-[50%] grow-0">
          ...
          <p className="mb-2 text-lg">
            Catagory: <span className="text-[#4f4f4f]">Pizza</span>
          </p>
      ...
      <section className="pt-14">
        <Segmented
          options={["Description", `Review (${product.qtyReview})`]}
